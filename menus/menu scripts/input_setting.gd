...
@onready var InputButton_scene = preload("res://menus/input_button.tscn")
...
var input_actions ={
	"character_up": "Move Up",
	"character_down": "Move Down",
	"character_right": "Move Right",
	"character_left": "Move Left",
	"interact": "Interact",
	"break": "Break",
}
...
func _create_action_list():
	...
	for action in input_actions:
		var button = InputButton_scene.instantiate()
